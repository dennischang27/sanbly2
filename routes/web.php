...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('/expense-categories/delete', 'ExpenseCategoriesController@delete')->name('expense-categories.delete');
	...
	Route::post('/invoices/download', 'InvoicesController@printPDF')->name('invoices.download');
	Route::get('/invoices/email', 'InvoicesController@email')->name('invoices.email');
	...
	Route::post('/vendors/delete', 'VendorsController@delete')->name('vendors.delete');
