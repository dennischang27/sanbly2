...
{{-- page title --}}
@section('title','Create Expenses Categories')
{{-- page style --}}
@section('page-styles')
        ...
        <div class="card-header">
			<h4 class="card-title">
				...
				<span style='display:inline-block;position:relative;float:right;'>
					<a href="{{ route('expenses-categories.index') }}" class="btn btn-sm btn-primary">{{ __('Back to Expenses Categories') }}</a>
				</span>
			</h4>
        </div>
        <div class="card-content">
          <div class="card-body">
            <form method="post" action="{{ route('expenses-categories.store') }}" class="form form-vertical" novalidate>
				@csrf
              <div class="form-body">
                <div class="row">
                  <div class="col-md-6">
